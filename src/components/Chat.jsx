...
const Chat = ({ token }) => {
  ...
  const [fakeChat, setFakeChat] = useState([
    {
      text: "Hej hopp, detta är Snuten från Kristianstad!",
    ...
    {
      text: "Vi tänkte ha partaj hos Christer P! så se till att ta med äkta vara denna gång.",
      avatar: "https://i.pravatar.cc/100",
      username: "Anonym användare",
      userId: "fakeId1",
      conversationId: null,
    ...
    {
      text: "Grymt Snuten! ser till att groggvirket är kylt åt Chrille P!, syns på fredag!",
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/src/components/Assets/ChatBackground.svg')",
      }}
    >
              ...
              {fakeChat.map((message, index) => (
                <div
                  ...
                  className={`message-item ${
                    message.userId === userId ? "user" : "other"
                  }`}
                >
                  <div
                  ...
                  >
                    <img
                      src={message.avatar}
                      alt="avatar"
                      className="message-avatar w-8 h-8 rounded-full"
                    />
                    <div
                    ...
                    >
                      ...
                      <p
                        ...
                        dangerouslySetInnerHTML={{
                          __html: sanitizeText(message.text),
                        }}
                      ></p>
                    </div>
                  </div>
